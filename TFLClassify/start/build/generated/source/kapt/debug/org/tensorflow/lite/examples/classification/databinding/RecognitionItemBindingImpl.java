package org.tensorflow.lite.examples.classification.databinding;
import org.tensorflow.lite.examples.classification.R;
import org.tensorflow.lite.examples.classification.BR;
...
public class RecognitionItemBindingImpl extends RecognitionItemBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.recognitionItem == variableId) {
            setRecognitionItem((org.tensorflow.lite.examples.classification.viewmodel.Recognition) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setRecognitionItem(@Nullable org.tensorflow.lite.examples.classification.viewmodel.Recognition RecognitionItem) {
    ...
    protected void executeBindings() {
        ...
        org.tensorflow.lite.examples.classification.viewmodel.Recognition recognitionItem = mRecognitionItem;
