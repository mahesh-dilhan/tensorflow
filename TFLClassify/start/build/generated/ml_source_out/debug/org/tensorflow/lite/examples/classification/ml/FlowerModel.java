package org.tensorflow.lite.examples.classification.ml;
...
/**
 * Identify the most prominent object in the image from a set of 5 categories. */
public final class FlowerModel {
  ...
  private FlowerModel(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "FlowerModel.tflite", options);
  ...
  @NonNull
  public static FlowerModel newInstance(@NonNull Context context) throws IOException {
    return new FlowerModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static FlowerModel newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new FlowerModel(context, options);
  }
